...
- **/ping** - ตรวจสอบความเร็วในการตอบสนองของบอท (แสดง latency)
- **/help** - แสดงคำสั่งทั้งหมดและข้อมูลบอท
- **/stats** - ดูสถิติการใช้งานบอทและคำสั่งยอดนิยม
...
- **Rate Limiting** - ป้องกันการ request มากเกินไปไปยัง external APIs
- **Image Caching** - Cache รูป Build ที่สร้างแล้วเพื่อลดเวลาในการสร้างซ้ำ
- **Health Check** - Endpoint `/health` สำหรับตรวจสอบสถานะบอท
- **Logger Utility** - ระบบ logging ที่มีโครงสร้าง
- **Command Cooldowns** - ป้องกันการ spam คำสั่ง
- **Input Validation** - ตรวจสอบและแนะนำชื่อแชมเปี้ยน
- **Error Handling** - จัดการ errors แบบ centralized
- **Command Statistics** - ติดตามการใช้งานคำสั่ง
